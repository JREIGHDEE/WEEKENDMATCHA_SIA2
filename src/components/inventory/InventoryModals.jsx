  ...
  <div style={{ ...styles.modalOverlay, zIndex: 1100 }}>
    <div style={{ ...styles.modalContent, width: '420px', textAlign: 'center' }}>
      ...
      <div style={summaryBoxStyle}>
        ...
        <p>
          <b>Quantity:</b> {selectedItem?.Quantity || formData.Quantity}{' '}
          {selectedItem?.UnitMeasurement || formData.UnitMeasurement}
        </p>
      </div>

      <div style={{ display: 'flex', justifyContent: 'center', gap: '15px' }}>
        <button
          onClick={() => setModals(prev => ({ ...prev, confirmArchive: false }))}
          style={{ ...styles.btnStyle, background: '#ccc', color: '#333' }}
        >
          Cancel
        </button>
